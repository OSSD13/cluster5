...
class PointOfInterestTypeController extends Controller
{
    ...
    public function insert(Request $request){
        ...
        [
            ...
            'icon.required' => 'กรุณากรอกข้อมูล ไอคอน',

            'color.required' => 'กรุณากรอกข้อมูล สี',
            'color.string' => 'กรุณากรอกข้อมูล สี เป็นตัวอักษร',
            'color.max' => 'กรุณากรอกข้อมูล สี ไม่เกิน 255 ตัวอักษร',
