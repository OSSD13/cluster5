...
=======
                <button type="submit"
                    class="bg-blue-600 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-800">Login</button>
>>>>>>> origin/develop
            </div>
...
=======
            <a class="flex items-center justify-center w-full p-2 rounded-md shadow-sm bg-white hover:bg-gray-100"
