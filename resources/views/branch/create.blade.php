...
@section('content')
    ...
    <div class="max-w-md mx-auto bg-white shadow-lg rounded-lg p-6">
        ...
        <input type="text" class="w-full p-2 border border-gray-300 rounded-lg mb-3" placeholder="Link Google" id="googleLink">
        ...
        <input type="text" class="w-full p-2 border border-gray-300 rounded-lg mb-3" placeholder="รหัสไปรษณีย์" id="zipcode">
