...
@section('screen')
    ...
    <!-- Navbar -->
    <nav :class="{'rounded-b-lg': !open}" class="sticky top-0 w-full h-20 bg-white flex items-center p-2 px-6 z-10 transition-all ease-out duration-10">
        <!-- Logo Section -->
        <div class="flex items-center flex-grow "><div class="flex items-center border-r border-gray-400 h-12 pr-4">
            <img src="/assets/img/logo_myLocation.png" alt="Logo" class="h-20">
        </div>
        </div>
        ...
        <button @click="open = !open" class="relative z-50">
            ...
            <svg x-show="open" xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24"><path fill="currentColor" d="m12 13.4l-4.9 4.9q-.275.275-.7.275t-.7-.275t-.275-.7t.275-.7l4.9-4.9l-4.9-4.9q-.275-.275-.275-.7t.275-.7t.7-.275t.7.275l4.9 4.9l4.9-4.9q.275-.275.7-.275t.7.275t.275.7t-.275.7L13.4 12l4.9 4.9q.275.275.275.7t-.275.7t-.7.275t-.7-.275z"/></svg>
        </button>
    </nav>
    ...
    <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-300 "
        ...
        <footer
            ...
            {{-- class="sticky bottom-0 w-full h- p-1 bg-gray-100 shadow flex items-center justify-around rounded-t-lg flex-shrink-0"> --}}
            @php
                $navItems = [
